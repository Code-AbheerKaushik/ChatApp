...
import { Bell, BellOff, Volume2, Smartphone, Eye, MessageSquare, Users, PhoneCall } from "lucide-react";
...
const NotificationsSection = () => {
  ...
  const toggleItems = [
    ...
    },
    {
      ...
      icon: Volume2,
      title: "In-App Sound",
      subtitle: "Play sound for incoming & outgoing messages",
      color: "text-info",
    },
    {
      key: "vibration",
    ...
    <div className="bg-base-100/90 backdrop-blur-md border border-base-300 rounded-2xl p-5 shadow-sm space-y-4">
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-xs text-base-content/60">Customize alerts, sound, and vibration settings</p>
        </div>
      </div>
