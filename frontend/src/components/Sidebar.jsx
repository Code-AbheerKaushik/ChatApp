...
const Sidebar = () => {
  ...
  const onlineContactsCount = users.filter((user) => onlineUsers.includes(String(user._id))).length;
      ...
      <div className="overflow-y-auto w-full py-3">
        {filteredUsers.map((user) => (
          ...
          >
            ...
            {/* User info - only visible on mobile (full width layout) and larger screens */}
